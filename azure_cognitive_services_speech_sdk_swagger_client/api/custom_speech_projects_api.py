...
class CustomSpeechProjectsApi(object):
    ...
    def update_project(self, id, project_update, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.update_project_with_http_info(id, project_update, **kwargs)  # noqa: E501
            return data
    ...
    def update_project_with_http_info(self, id, project_update, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('project_update' not in params or
            ...
            raise ValueError("Missing the required parameter `project_update` when calling `update_project`")  # noqa: E501
