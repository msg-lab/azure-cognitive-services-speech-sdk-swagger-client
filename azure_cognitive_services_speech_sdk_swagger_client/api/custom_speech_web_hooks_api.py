...
class CustomSpeechWebHooksApi(object):
    ...
    def create_hook_with_http_info(self, web_hook, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('web_hook' not in params or
            ...
            raise ValueError("Missing the required parameter `web_hook` when calling `create_hook`")  # noqa: E501
    ...
    def update_hook(self, id, web_hook_update, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_hook_with_http_info(id, web_hook_update, **kwargs)  # noqa: E501
        else:
            (data) = self.update_hook_with_http_info(id, web_hook_update, **kwargs)  # noqa: E501
            return data
    ...
    def update_hook_with_http_info(self, id, web_hook_update, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('web_hook_update' not in params or
            ...
            raise ValueError("Missing the required parameter `web_hook_update` when calling `update_hook`")  # noqa: E501
