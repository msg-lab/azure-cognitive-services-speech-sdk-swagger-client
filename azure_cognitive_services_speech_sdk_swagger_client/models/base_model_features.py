...
class BaseModelFeatures(object):
    ...
    """
    swagger_types = {"supports_adaptations_with": "list[DatasetKind]"}

    attribute_map = {"supports_adaptations_with": "supportsAdaptationsWith"}

    def __init__(
        self, supports_adaptations_with=None, _configuration=None
    ):  # noqa: E501
