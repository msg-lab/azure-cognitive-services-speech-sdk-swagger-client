...
class CustomModelLinks(object):
    ...
    """
    swagger_types = {"copy_to": "str", "files": "str", "manifest": "str"}

    attribute_map = {"copy_to": "copyTo", "files": "files", "manifest": "manifest"}

    def __init__(
        self, copy_to=None, files=None, manifest=None, _configuration=None
    ):  # noqa: E501
