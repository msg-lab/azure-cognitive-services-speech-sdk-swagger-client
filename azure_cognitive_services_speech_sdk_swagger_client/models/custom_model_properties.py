...
class CustomModelProperties(object):
    ...
    def __init__(
        self,
        custom_model_weight_percent=None,
        deprecation_dates=None,
        features=None,
        email=None,
        error=None,
        _configuration=None,
    ...
    def custom_model_weight_percent(self, custom_model_weight_percent):
        ...
        if (
            ...
            and custom_model_weight_percent is not None
            and custom_model_weight_percent > 100
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `custom_model_weight_percent`, must be a value less than or equal to `100`"
            )  # noqa: E501
        if (
            self._configuration.client_side_validation
            and custom_model_weight_percent is not None
            and custom_model_weight_percent < 1
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `custom_model_weight_percent`, must be a value greater than or equal to `1`"
            )  # noqa: E501
