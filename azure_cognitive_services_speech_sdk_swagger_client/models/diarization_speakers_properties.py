...
class DiarizationSpeakersProperties(object):
    ...
    """
    swagger_types = {"min_count": "int", "max_count": "int"}

    attribute_map = {"min_count": "minCount", "max_count": "maxCount"}

    def __init__(
        self, min_count=None, max_count=None, _configuration=None
    ):  # noqa: E501
    ...
    def min_count(self, min_count):
        ...
        if (
            ...
            raise ValueError(
                "Invalid value for `min_count`, must be a value greater than or equal to `1`"
            )  # noqa: E501
